...
public class EmailSenderService {
    ...
    public void sendEmail(Boolean isForActivation, String username, String receiver, String url, String subject) throws MailException {
        ...
        try {
            ...
            String activationMessageContent = "<div style='width: 100%; height: 600px; background-color: #282828; color: #ccc;'><h1 style='padding:50px;width: 100%; text-align:center;font-size:35px'>Hey " + username + ", welcome to Tipear!<h1><hr><br>" +
            ...
            String passwordMessageContent = "<div style='width: 100%; height: 600px; background-color: #282828; color: #ccc;'><h1 style='padding:50px;width: 100%; text-align:center;font-size:35px'>Password recovery<h1><hr><br>" +
                    "<h2 style='text-align: center; font-size: 20px;'>Reset your password by clicking the button or the link.</h2><br>"
